	...
	return (
		<footer className={styles.footer}>
			<div className={styles.contactUs}>
				<div>Contract address: <a href={`https://snowtrace.io/token/${process.env.NEXT_PUBLIC_CONTRACT_ADDRESS}`} target='_blank' rel='noreferrer' data-link-name='Snowtrace' onClick={clickedLink}>{process.env.NEXT_PUBLIC_CONTRACT_ADDRESS}</a></div>
